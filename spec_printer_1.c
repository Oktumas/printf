...
convert_fmt_xX(s) nul(va_list *args_list, fmt_info_t *fmt_info)
{
 ...
 max_w = MAX(fmt_info->largeur, num_len), max_p = MAX(fmt_info->prec, num_len);
...
/**
 * convert_fmt_o - Imprime le format octadécimal d’un argument int signé
 * @args_list : La liste des arguments
 * @fmt_info: Les informations sur le format
 *
 * Retour: Le nombre de caractères écrits
 */
convert_fmt_o(va_list *args_list, fmt_info_t *fmt_info)
{
